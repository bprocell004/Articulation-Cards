...
public class s_cards extends AppCompatActivity {
    //variable declarations
    int[] images= {R.drawable.sloth2, R.drawable.seal, R.drawable.seven};
    String[] text= {"Sloth", "Seal", "Seven"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s_cards);
        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                attemptText.setText("Attempts: " + attempts);
                scoreText.setText("Score: " + df.format(check));
                Intent registerScreen = new Intent(s_cards.this, MainActivity.class);
