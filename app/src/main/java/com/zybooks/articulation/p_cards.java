...
public class p_cards extends AppCompatActivity {
    //variable declarations
    int[] images= {R.drawable.panda1, R.drawable.pirate, R.drawable.piano};
    String[] text= {"Panda", "Pirate", "Piano"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.p_cards);
        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                attemptText.setText("Attempts: " + attempts);
                scoreText.setText("Score: " + df.format(check));
                Intent registerScreen = new Intent(p_cards.this, MainActivity.class);
