...
public class r_cards extends AppCompatActivity {
    //variable declarations
    int[] images= {R.drawable.racoon1, R.drawable.rabbit, R.drawable.rocket};
    String[] text= {"Racoon", "Rabbit", "Rocket"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r_cards);
        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                attemptText.setText("Attempts: " + attempts);
                scoreText.setText("Score: " + df.format(check));
                Intent registerScreen = new Intent(r_cards.this, MainActivity.class);
