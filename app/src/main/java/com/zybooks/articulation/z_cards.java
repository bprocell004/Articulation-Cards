...
public class z_cards extends AppCompatActivity {

    //variable declarations
    int[] images= {R.drawable.zebra1, R.drawable.zombie, R.drawable.zipper};
    String[] text= {"Zebra", "Zombie", "Zipper"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.z_cards);
        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                attemptText.setText("Attempts: " + attempts);
                scoreText.setText("Score: " + df.format(check));
                Intent registerScreen = new Intent(z_cards.this, MainActivity.class);
