...
public class w_cards extends AppCompatActivity {
    //variable declarations
    int[] images= {R.drawable.walrus1, R.drawable.world, R.drawable.window};
    String[] text= {"Walrus", "World", "Window"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.w_cards);
        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                attemptText.setText("Attempts: " + attempts);
                scoreText.setText("Score: " + df.format(check));
                Intent registerScreen = new Intent(w_cards.this, MainActivity.class);
