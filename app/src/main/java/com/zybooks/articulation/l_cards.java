...
public class l_cards extends AppCompatActivity {
    //variable declarations
    int[] images= {R.drawable.lion1, R.drawable.lizard, R.drawable.ladybug};
    String[] text= {"Lion", "Lizard", "Ladybug"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.l_cards);
    ...
    //variable declarations for buttons and textViews of layout file
        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                attemptText.setText("Attempts: " + attempts);
                scoreText.setText("Score: " + df.format(check));
                Intent registerScreen = new Intent(l_cards.this, MainActivity.class);
