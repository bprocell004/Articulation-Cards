...
public class t_cards extends AppCompatActivity {
    //variable declarations
    int[] images= {R.drawable.tcard1, R.drawable.tcard2, R.drawable.turkey};
    String[] text= {"Turtle", "Tree", "Turkey"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.t_cards);
        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                attemptText.setText("Attempts: " + attempts);
                scoreText.setText("Score: " + df.format(check));
                Intent registerScreen = new Intent(t_cards.this, MainActivity.class);
